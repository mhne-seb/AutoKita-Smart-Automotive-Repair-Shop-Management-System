...
export async function notifyCustomer(opts: {
  jobOrderId: number
  entityType: 'service_progress_tasks' | 'service_findings' | 'job_order_parts' | 'road_tests' | 'payments' | 'job_orders' | 'pull_out_requests' | 'scan_authorizations' | 'warranty_claims'
  entityId: number
